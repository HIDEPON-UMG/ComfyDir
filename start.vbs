...
'
' Double-click this file to start the server with pythonw.exe in hidden mode.
' run.py will open the browser automatically.
...
Dim shell, fso, scriptDir, pyw, runpy, cmd
...
If Not fso.FileExists(runpy) Then
  MsgBox "run.py not found: " & runpy, vbCritical, "ComfyDir"
  WScript.Quit 1
End If
